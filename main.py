...
def comp_play():
    comp_play.append(draw_card(comp_field))


def comp_deck_field():
    comp_deck.append(draw_card(comp_deck))
...
def player_play():
    user_play.append(draw_card(player_field))
...
comp_health_frame = tkinter.Frame(mainWindow, relief="sunken", borderwidth=1, background="bisque", width=200, height=300)
...
tkinter.Label(comp_health_frame, textvariable=comp_health_frame, background="bisque", fg="black").grid(row=1, column=0)
...
comp_deck_frame = tkinter.Frame(mainWindow, relief="raised", borderwidth=10, background="bisque")
comp_deck_frame.grid(row=0, column=1, sticky="ew", columnspan=1, rowspan=1)
# load card backing to the deck frame
comp_deck = tkinter.Frame(comp_deck_frame, background="bisque")
comp_deck.grid(row=0, column=0)
...
comp_player_frame.grid(row=0, column=1, sticky="ew", rowspan=1)

# frame for comp discard pile
comp_dis_frame = tkinter.Frame(mainWindow, relief="sunken", borderwidth=3, background="bisque")
comp_dis_frame.grid(row=0, column=3, sticky="e", columnspan=1, rowspan=1)
# draw a card into the discard pile
comp_dis_pile = tkinter.Frame(comp_dis_frame, background="bisque")
comp_dis_pile.grid(row=0, column=0)
########################################################################
# main window row 1
comp_field_frame = tkinter.Frame(mainWindow, relief="raised", borderwidth=10, background="magenta")
comp_field_frame.grid(row=1, column=2, sticky="ew", rowspan=5)
# draws a card to the comp player frame
comp_field = tkinter.Frame(comp_field_frame, background="yellow")
comp_field.grid(row=0, column=1, sticky="ew", rowspan=5)
########################################################################
########################################################################
# main window row 2
player_field = tkinter.Frame(mainWindow, relief="raised", borderwidth=10, bg="brown")
player_field.grid(row=2, column=2, sticky="ew", rowspan=5)
# draws a cards to the player play field
player_field_play = tkinter.Frame(player_field, background="green")
player_field_play.grid(row=0, column=0, sticky="ew", rowspan=5)
#######################################################
# main window row 3
...
player_health_frame.grid(row=3, column=0, sticky="ew", columnspan=1, rowspan=1)
...
player_frame = tkinter.Frame(comp_deck_frame, background="green")
player_frame.grid(row=3, column=1, sticky="ew", rowspan=2)
# create a frame to hold the players discard pile
player_dis_pile = tkinter.Frame(mainWindow, relief="sunken", borderwidth=10, background="green")
# for testing purposes to make sure things line ups do the copypasta early
# draw cards into the user hand window
player_hand_frame = tkinter.Frame(mainWindow, relief="sunken", borderwidth=1, background="blue")
player_hand_frame.grid(row=3, column=2, sticky="ew", columnspan=1, rowspan=5)
# draws a card for the user player through the player draw button
user_player_frame = tkinter.Frame(player_hand_frame, background="magenta")
user_player_frame.grid(row=3, column=1, sticky="ew", rowspan=1)
########################################################
# main window row 4
...
########################################
button_frame.grid(row=4, column=0, columnspan=4, sticky="w")
...
comp_deck_button = tkinter.Button(button_frame, text="com deck", command=comp_deck_field)
comp_deck_button.grid(row=1, column=0)

comp_play = tkinter.Button(button_frame, text="comp play", command=comp_play)
comp_play.grid(row=1, column=1)

comp_dis_button = tkinter.Button(button_frame, text="comp discard", command=comp_dis_pile)
comp_dis_button.grid(row=1, column=2)


user_play = tkinter.Button(button_frame, text="player play", command=player_play)
user_play.grid(row=2, column=0)
################################################################################
cards = []
load_cards(cards)
print(cards)
